package com.zengjun.chargeClient.adapter;
...
//        Log.d("B1","1、find view");
        ...
        switch (helper.getItemViewType()) {
            ...
            case MultipleItem.TYPE_ORDER:
                helper.setImageDrawable(R.id.my_order_image, ContextCompat.getDrawable(mContext, R.drawable.ic_order));
            ...
            case MultipleItem.TYPE_BALANCE:
                ...
                helper.addOnClickListener(R.id.my_code_add);
                break;
            case MultipleItem.TYPE_TOOLS_HEADER:
                helper.addOnClickListener(R.id.ll_my_cost);
                //helper.setText(R.id.tv_item_name, item.mString1);
                break;
            case MultipleItem.TYPE_TOOLS:
                helper.setImageDrawable(R.id.my_tools_image, ContextCompat.getDrawable(mContext, R.drawable.ic_cost));
